...
|Emil|Filip |
|:--|:--|
| `CMV` function 2,6,10 and 14 <br/> `FUV`, `main` functions <br/>Tests 0,3,7 and 11 <br/> `PUM` test <br/> 1 test project| Variables & Skeleton <br/> `CMV` function 1,5,9 and 13 <br/> Tests 2,6,10 and 14 <br/> 1 test project|
|**Julien** | **Susie** |
JUnit test skeleton <br/> `CMV` function 0,4,8 and 12 <br/> `DECIDE` function <br/> Tests 1,5,9 and 13 <br/> Write the README <br/> Test `DECIDE`, `FUV` functions <br/> 2 tests projet | `CMV` function 3,7 and 11 <br/> `PUM`, `LAUNCH` functions <br/> Tests 4,8 and 12 <br/>  Test `LAUNCH`<br/> 1 test project
